...
export const API_ROLES = API_URL + 'miapi/privado/role/getAll'
export const API_ROLES_ELIMINAR = API_URL + 'miapi/privado/role/delete';
export const API_ROLES_CREAR = API_URL + 'miapi/privado/role/create';
